...
def insert(request):
    try:
        ...
        return render(request, 'myadmin/user/insert.html', context)
...
def delete(request, u_id=0):
    ...
    try:
        ...
        context = {'info': "Removing %s failed, Please try again." % del_user.Email,
                   'add_status': 0}
    return render(request, 'myadmin/user/delete.html', context)
...
def recovery(request, u_id=0):
    ...
    try:
        ...
        context = {'info': "Information recovery failed, Please try again.",
                   'add_status': 0}
    return render(request, 'myadmin/user/recovery.html', context)
...
def updated(request, u_id):
    ...
    return render(request, 'myadmin/user/update.html', context)
